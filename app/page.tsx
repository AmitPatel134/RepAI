    ...
    <main className="min-h-screen text-gray-900">
      ...
      <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-5xl flex items-center justify-between px-4 py-2.5 rounded-2xl bg-gray-950/80 backdrop-blur-xl border border-white/[0.08] shadow-2xl shadow-black/30">
        ...
        <div className="hidden md:flex items-center gap-1 absolute left-1/2 -translate-x-1/2">
          <a href="#features" className="px-3 py-1.5 text-sm font-semibold text-gray-400 hover:text-white rounded-xl hover:bg-white/5 transition-all">Fonctionnalités</a>
          <a href="#pricing" className="px-3 py-1.5 text-sm font-semibold text-gray-400 hover:text-white rounded-xl hover:bg-white/5 transition-all">Tarifs</a>
        </div>
        <div className="flex items-center gap-2">
          {email ? (
            <button onClick={() => setConfirm(true)} className="text-sm font-bold text-gray-400 px-3 py-2 rounded-xl hover:text-white hover:bg-white/5 transition-all">
              Déconnexion
            </button>
          ) : (
            <a href="/login" className="text-sm font-bold text-gray-400 px-3 py-2 rounded-xl hover:text-white hover:bg-white/5 transition-all">
              Connexion
            </a>
          )}
          <a href={ctaHref} className="bg-violet-600 text-white font-bold text-sm px-4 py-2 rounded-xl hover:bg-violet-500 transition-colors shadow-lg shadow-violet-900/40">
